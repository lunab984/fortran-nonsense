...
OPEN(UNIT = 10, FILE = 'xharmonicnum.dat')
OPEN(UNIT = 20, FILE = 'vharmonicnum.dat')
OPEN(UNIT = 30, FILE = 'keharmonicnum.dat')
OPEN(UNIT = 40, FILE = 'peharmonicnum.dat')
OPEN(UNIT = 50, FILE = 'ssnharmonicnum.dat')
	WRITE(10, *) '# t, x'
	WRITE(20,*) '# t, v'
	WRITE(30,*) '# t, KE'
	WRITE(40,*) '# t, PE'
